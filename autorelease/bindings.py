R"""
Auto-generated by:
ctypesgen -l pdfium --rt-libpaths './{prefix}{name}.{suffix}' /usr/lib64/libreoffice/program/libpdfiumlo.so /usr/lib/libreoffice/program/libpdfiumlo.so /usr/local/lib64/libreoffice/program/libpdfiumlo.so /usr/local/lib/libreoffice/program/libpdfiumlo.so --no-load-library --no-macro-guards --no-srcinfo -D PDF_ENABLE_V8 PDF_ENABLE_XFA PDF_USE_SKIA -D _WIN32 -I '~/work/pypdfium2/pypdfium2/setupsrc/include/windows' --symbol-rules 'if_needed=\w+_$|\w+_t$|_\w+' --headers fpdf_annot.h fpdf_attachment.h fpdf_catalog.h fpdf_dataavail.h fpdf_doc.h fpdf_edit.h fpdf_ext.h fpdf_flatten.h fpdf_formfill.h fpdf_fwlevent.h fpdf_javascript.h fpdf_ppo.h fpdf_progressive.h fpdf_save.h fpdf_searchex.h fpdf_signature.h fpdf_structtree.h fpdf_sysfontinfo.h fpdf_text.h fpdf_thumbnail.h fpdf_transformpage.h fpdfview.h -o '~/work/pypdfium2/pypdfium2/data/bindings/bindings.py'
"""
...
if hasattr(_libs['pdfium'], 'FPDF_SetPrintMode'):
...
FPDF_TEXT_DIRECTION = enum_anon_6
...
if hasattr(_libs['pdfium'], 'FORM_GetTextDirection'):
...
if hasattr(_libs['pdfium'], 'FORM_SetTextDirection'):
...
if hasattr(_libs['pdfium'], 'FPDFAnnot_SetFormFieldFlags'):
...
if hasattr(_libs['pdfium'], 'FPDFAnnot_SetFontColor'):
...
if hasattr(_libs['pdfium'], 'FPDFAttachment_SetDescription'):
...
if hasattr(_libs['pdfium'], 'FPDFAttachment_GetDescription'):
...
if hasattr(_libs['pdfium'], 'FPDFAttachment_GetSubtype'):
...
if hasattr(_libs['pdfium'], 'FPDFCatalog_GetLanguage'):
...
if hasattr(_libs['pdfium'], 'FPDFFormObj_RemoveObject'):
