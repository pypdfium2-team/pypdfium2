...
_libs['pdfium'] = _get_library(
    ...
    libpaths = ('./{prefix}{name}.{suffix}', '/usr/lib/libreoffice/program/libpdfiumlo.so', '/usr/lib64/libreoffice/program/libpdfiumlo.so', '/usr/local/lib/libreoffice/program/libpdfiumlo.so', '/usr/local/lib64/libreoffice/program/libpdfiumlo.so'),
    search_sys = True,
)
