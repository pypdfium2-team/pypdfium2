...
def colour_tohex(r, g, b, a=255):
    ...
    Returns:
        (:class:`int`, :class:`bool`) – The colour value, and a boolean signifying if an alpha channel is needed.
    """
...
def get_colourformat(use_alpha, greyscale):
    ...
    Returns:
        (:class:`str`, :class:`int`) – The colour format as string, and as PDFium colour format constant (``FPDFBitmap_...``).
    """
...
#: Get the object type string that corresponds to an object type constant
ObjtypeToName = {
