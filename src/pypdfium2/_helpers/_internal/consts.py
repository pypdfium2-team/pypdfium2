...
#: Get the number of channels for a PDFium bitmap format.
...
#: Convert a PDFium bitmap format to string, assuming BGR byte order.
BitmapTypeToStr = {
...
#: Convert a PDFium bitmap format to string, assuming RGB byte order.
...
#: Convert a PDFium form type to string.
FormTypeToStr = {
