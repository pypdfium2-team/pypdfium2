...
class PdfPage (AutoCloseable):
    ...
    def get_width(self):
        ...
        """
        return pdfium_c.FPDF_GetPageWidthF(self.raw)
    ...
    def get_height(self):
        ...
        """
        return pdfium_c.FPDF_GetPageHeightF(self.raw)
    ...
    def get_rotation(self):
        ...
        """
        return consts.RotationToDegrees[ pdfium_c.FPDFPage_GetRotation(self.raw) ]
    
    def set_rotation(self, rotation):
        """
        Define the absolute, clockwise page rotation (0, 90, 180, or 270 degrees).
        """
        pdfium_c.FPDFPage_SetRotation(self.raw, consts.RotationToConst[rotation])
    ...
    def get_bbox(self):
        ...
        success = pdfium_c.FPDF_GetPageBoundingBox(self.raw, rect)
        if not success:
    ...
    def get_textpage(self):
        ...
        """
        textpage = pdfium_c.FPDFText_LoadPage(self.raw)
        if not textpage:
    ...
    def insert_object(self, pageobj):
        ...
        pdfium_c.FPDFPage_InsertObject(self.raw, pageobj.raw)
    ...
    def remove_object(self, pageobj):
        ...
        pdfium_c.FPDFPage_RemoveObject(self.raw, pageobj.raw)
    ...
    def generate_content(self):
        ...
        """
        success = pdfium_c.FPDFPage_GenerateContent(self.raw)
        if not success:
    ...
    def _flatten(self, flag=pdfium_c.FLAT_NORMALDISPLAY):
        ...
        """
        rc = pdfium_c.FPDFPage_Flatten(self.raw, flag)
    ...
    def render(
        ...
        if color_scheme is None:
            ...
            pause = utils.get_pause_struct(lambda _: False)
