...
class PdfPage:
    ...
    def get_mediabox(self):
        """
        Returns:
            The page MediaBox in PDF canvas units.
            It is a sequence of four :class:`float` coordinates for left, bottom, right, and top (x0, y0, x1, y1).
    ...
    def set_mediabox(self, l, b, r, t):
        """
        Set the page's MediaBox by passing for :class:`float` coordinates for left, bottom, right, and top (x0, y0, x1, y1).
        """
    ...
    def _get_obj(self, index):
        raw_obj = pdfium.FPDFPage_GetObject(self._page, index)
        return PdfPageObject(raw_obj)
