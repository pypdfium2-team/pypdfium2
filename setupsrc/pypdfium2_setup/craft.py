...
def tmp_ctypesgen_pin():
    ...
    if not pin:
        head_url = "https://api.github.com/repos/pypdfium2-team/ctypesgen/git/refs/heads/refactor_libload"
    ...
    ctx = tmp_replace_ctx(ProjectDir/"pyproject.toml", base_txt+"refactor_libload", base_txt+pin)
    with ctx:
