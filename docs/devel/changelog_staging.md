...
- Largest CI/workflows rework yet ("strategic builds"). Many testing gaps filled (see the updated platform support table).
  ...
  We would probably explore making our own releases from time to time, but otherwise continue to use pdfium-binaries as primary strategy for the foreseeable future.
