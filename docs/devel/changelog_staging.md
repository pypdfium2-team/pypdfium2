...
- `build_native.py`: Added full dependency library vendoring abilities, including libc++. This is now the default behavior on fallback setup. Integrated ninja/gn bootstrapping helpers.
