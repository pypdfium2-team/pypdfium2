...
- Experimental PyEmscripten wasm32 (Pyodide) build support added. However, the resulting builds are known to be flaky at runtime and susceptible to various types of crashes. Freezes at shutdown have also been observed.
