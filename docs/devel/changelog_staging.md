...
- Also dropped module splitting (`PYPDFIUM_MODULES={raw,helpers}`) and the `system-generate` target, which had been introduced for pypdfium2's own conda packaging.
