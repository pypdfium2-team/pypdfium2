...
- Updated PDFium from `5567` to `5579` (autorelease).
...
- Updated PDFium from `5527` to `5541` (autorelease).


## 3.17.0 (2023-01-09)

- Updated PDFium from `5513` to `5527` (autorelease).


## 3.16.0 (2023-01-02)

- Updated PDFium from `5499` to `5513` (autorelease).


## 3.15.0 (2022-12-26)

- Updated PDFium from `5485` to `5499` (autorelease).


## 3.14.0 (2022-12-19)

- Updated PDFium from `5473` to `5485` (autorelease).


## 3.13.0 (2022-12-12)

- Updated PDFium from `5466` to `5473` (autorelease).
...
- Updated PDFium from `5431` to `5445` (autorelease).


## 3.9.0 (2022-11-21)

- Updated PDFium from `5418` to `5431` (autorelease).
...
*Releases 3.6 to 3.8 do no run on Docker due to an issue with PDFium's partition allocator.*
...
- Fixed build script on Windows (patches, Windows SDK and RC).
- Fixed test suite on Windows (cleanup failure).
- Fixed test suite on Python < 3.7 (image comparison failure).
